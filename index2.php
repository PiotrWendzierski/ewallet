					 ...
					 else
					 {
						 ...
						 if($ile_kategorii !=0)
						 {
							 ...
							 while($row = $rezultat -> fetch_assoc())
							 {
								 ...
								 if($rezultat2->num_rows>0) echo $kategoria." - " ;
								 if($laczna_ilosc_transakcji>0)
								{
									$i++;
									echo $laczna_ilosc_transakcji."</br>";
									if($i >= 5)break;
								}
			
							 }
							 if($i == 0 )echo "Brak wydatków w tym miesiącu!";
						 }
					...
					if($polaczenie->connect_errno!=0)
					{
					 ...
					 else
					 {
						 ...
						 if($ile_kategorii !=0)
						 {
							 ...
							 if($i == 0 )echo "Brak wpływów w tym miesiącu!";
						 }
