...
<div id="container">
	...
	<div class="filtring">
		<a class="pokas" href="kategorie_wydatkowprocent.php"><input type='submit' class='filtruj' value = 'POKAŻ WYKRES KWOTOWY' /></a>		
	</div>
	<div class="filtring">
			...
			if($ile_kategorii >0)
			{
				$i = 0;
				 while($row = $rezultat -> fetch_assoc())
				 {
					 ...
					 $sql5 = "SELECT * FROM transakcje WHERE id ='$id' AND wplywwyplyw = 'wyplyw' AND kategoria = '$kategoria' AND data BETWEEN '$od'
					 AND '$do'";
